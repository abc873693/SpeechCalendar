...
public class RoomFragment extends BaseFragment {
    ...
    private void setView() {
        roomItemAdapter = new RoomItemAdapter(getActivity(), getBaseApplication().getMqttHelper(), getRoomItemList(), new RoomItemAdapter.OnItemClickListener() {
            @Override
        ...
        getBaseApplication().getMqttHelper().setRoomCallback(new RoomCallback() {
            @Override
            public void onError() {
                super.onError();
            }
    ...
    public void onDestroyView() {
        super.onDestroyView();
        unbinder.unbind();
        getBaseApplication().getMqttHelper().setRoomCallback(null);
    }
}
